...
export const ManageLibraryPage = () => {
    ...
    //if user is not admin, reroute to home page when accessing /admin
            ...
            <div className="mt-5">
                ...
                <nav>
                    <div className="nav nav-tabs" id='nav-tab' role="tablist">
                        ...
                        <button onClick={changeQuantityOfBooksClickFunction} className='nav-link' id='nav-quantity-book-tab' data-bs-toggle='tab'
